...
let btnFileDelete = document.getElementById("btnFileDelete");       // 파일 삭제 버튼
...
function fnSave() {
    ...
    if(confirm("수정하시겠습니까?")){
        ...
        ajaxAPI("/board/modify", jsonData, "POST").then(response => {
...
function appendEditorHtml() {
    ...
    nhn.husky.EZCreator.createInIFrame({
        ...
        fOnAppLoad: function() {
            ...
            oEditor.getById["editorTxt"].exec("PASTE_HTML", [tempContent.value]);
...
function addEventListenerCRUDBtn(){
    ...
    btnFileDelete.addEventListener("click", fnFileDelete);
}
